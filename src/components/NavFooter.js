		...
		<section className="footer-nav-container">
			<nav className="footer-nav">
				<ul className="footer-nav-menu">
					<li className="nav-footer-logo">{footerBookmarkLogo}</li>
					<li className="nav-footer-links">Features</li>
					<li className="nav-footer-links">Pricing</li>
					<li className="nav-footer-links">Contact</li>
				</ul>
				<ul>
					<li className="social-footer-links">
						<svg
							id="facebook"
